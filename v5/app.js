...
// 学缘构成数据（区分专任/非专任）
const originCompositionData = {
    all: { data: [35, 45, 20], label: '全部', percentLocal: 35, localCount: 35, rank: '第6/28位', rankLevel: '上游' },
    teacher: { data: [30, 50, 20], label: '专任教师', percentLocal: 30, localCount: 26, rank: '第8/28位', rankLevel: '中上游' },
    'non-teacher': { data: [45, 40, 15], label: '非专任教师', percentLocal: 45, localCount: 9, rank: '第4/28位', rankLevel: '上游' }
};

// 高层次人才数据
const talentData = {
    college: [
        { id: 4, name: '刘洋', title: '教授', education: '博士', gender: '男', birthDate: '1968-11-25', talent: '院士', talentYear: 2015, talents: ['院士'] },
        { id: 14, name: '林峰', title: '教授', education: '博士', gender: '男', birthDate: '1960-03-10', talent: '院士', talentYear: 2018, talents: ['院士'] },
        { id: 2, name: '李强', title: '教授', education: '博士', gender: '男', birthDate: '1972-08-20', talent: '长江学者', talentYear: 2016, talents: ['长江学者', '杰青'] },
        { id: 6, name: '赵磊', title: '教授', education: '博士', gender: '男', birthDate: '1970-09-12', talent: '长江学者', talentYear: 2017, talents: ['长江学者'] },
        { id: 8, name: '周明', title: '教授', education: '博士', gender: '男', birthDate: '1969-07-08', talent: '长江学者', talentYear: 2019, talents: ['长江学者', '杰青'] },
        { id: 12, name: '马骏', title: '教授', education: '博士', gender: '男', birthDate: '1968-05-15', talent: '长江学者', talentYear: 2020, talents: ['长江学者'] },
        { id: 3, name: '王芳', title: '教授', education: '博士', gender: '女', birthDate: '1970-03-15', talent: '杰青', talentYear: 2014, talents: ['杰青', '青年人才'] },
        { id: 5, name: '陈静', title: '教授', education: '博士', gender: '女', birthDate: '1972-04-25', talent: '杰青', talentYear: 2016, talents: ['杰青'] },
        { id: 10, name: '郑强', title: '教授', education: '博士', gender: '男', birthDate: '1966-05-08', talent: '杰青', talentYear: 2015, talents: ['杰青', '长江学者'] },
        { id: 13, name: '高洁', title: '教授', education: '博士', gender: '女', birthDate: '1973-09-20', talent: '杰青', talentYear: 2018, talents: ['杰青'] },
        { id: 11, name: '黄磊', title: '教授', education: '博士', gender: '男', birthDate: '1973-06-20', talent: '青年人才', talentYear: 2020, talents: ['青年人才'] },
        { id: 18, name: '赵刚', title: '副教授', education: '博士', gender: '男', birthDate: '1981-09-30', talent: '青年人才', talentYear: 2021, talents: ['青年人才'] },
        { id: 23, name: '胡敏', title: '副教授', education: '博士', gender: '女', birthDate: '1986-03-25', talent: '青年人才', talentYear: 2022, talents: ['青年人才'] },
        { id: 26, name: '何明', title: '副教授', education: '博士', gender: '男', birthDate: '1985-01-20', talent: '青年人才', talentYear: 2022, talents: ['青年人才'] },
        { id: 33, name: '沈丽', title: '副教授', education: '博士', gender: '女', birthDate: '1986-04-20', talent: '青年人才', talentYear: 2023, talents: ['青年人才'] },
        { id: 89, name: '许强', title: '副教授', education: '博士', gender: '男', birthDate: '1984-07-30', talent: '青年人才', talentYear: 2021, talents: ['青年人才'] },
    ],
    department: [
        { id: 1, name: '王建国', title: '正高级工程师', education: '博士', gender: '男', birthDate: '1968-05-20', talent: '学科带头人', talentYear: 2019, talents: ['学科带头人'] },
        { id: 12, name: '张丽华', title: '高级工程师', education: '博士', gender: '女', birthDate: '1976-11-25', talent: '技术骨干', talentYear: 2021, talents: ['技术骨干'] },
    ]
};
...
function showCollegeAnalysisTab(tab) {
    ...
    document.getElementById('analysis-origin-content').style.display = 'none';
    ...
    if (tab === 'age') {
        ...
        document.getElementById('analysis-origin-content').style.display = 'block';
        initCollegeOriginChart();
    } else if (tab === 'cross') {
...
function showDeptAnalysisTab(tab) {
    ...
    document.getElementById('dept-analysis-origin-content').style.display = 'none';
    ...
    if (tab === 'age') {
        ...
        document.getElementById('dept-analysis-origin-content').style.display = 'block';
        initDeptOriginChart();
    } else if (tab === 'cross') {
...
// 学院学缘构成图表
function initCollegeOriginChart() {
    const ctx = document.getElementById('college-origin-chart');
    if (!ctx) return;
    
    // 销毁旧图表
    if (collegeOriginChart) {
        collegeOriginChart.destroy();
        collegeOriginChart = null;
    }
    
    const filterData = originCompositionData[currentStaffFilter] || originCompositionData.all;
    
    collegeOriginChart = new Chart(ctx.getContext('2d'), {
        type: 'doughnut',
        data: {
    ...
    // 更新指标卡数据
    updateOriginIndicators(filterData);
}

// 更新学缘指标卡
function updateOriginIndicators(data) {
    const percentEl = document.querySelector('#analysis-origin-content .rank-value');
    const countEl = document.querySelectorAll('#analysis-origin-content .rank-value')[1];
    const rankEl = document.querySelector('#analysis-origin-content .rank-badge');
    
    if (percentEl) percentEl.textContent = data.percentLocal + '%';
    if (countEl) countEl.textContent = data.localCount + '人';
    if (rankEl) {
        rankEl.textContent = '同类' + data.rank + ' · ' + data.rankLevel;
        rankEl.className = 'rank-badge ' + (data.rankLevel === '上游' ? 'good' : data.rankLevel === '中上游' ? 'medium' : data.rankLevel === '中下游' ? 'warning' : 'danger');
    }
...
// 部门学缘构成图表
function initDeptOriginChart() {
    const ctx = document.getElementById('dept-origin-chart');
    if (!ctx) return;
    
    // 销毁旧图表
    if (deptOriginChart) {
        deptOriginChart.destroy();
        deptOriginChart = null;
    }
    
    deptOriginChart = new Chart(ctx.getContext('2d'), {
        type: 'doughnut',
        data: {
            labels: ['本校学缘', '国内学缘', '海外学缘'],
            datasets: [{
...
// 渲染合同制名单
function renderContractList(persons, unitType) {
    const containerId = unitType === 'college' ? 'contract-list' : 'contract-list-dept';
    const container = document.getElementById(containerId);
    if (!container) return;
    
    container.innerHTML = persons.map(person => `
        <div class="person-item" onclick="showPersonDetail(${person.id}, '${unitType}')">
            <div class="person-avatar">${person.name.charAt(0)}</div>
            <div class="person-info">
                <div class="person-name">
                    ${person.name}
                    <span class="person-tag">合同制</span>
                </div>
                <div class="person-detail">${person.title} · ${person.education} · ${person.gender}</div>
            </div>
        </div>
...
// 渲染博士后名单
function renderPostdocList(persons, unitType) {
    const containerId = 'postdoc-list';
    const container = document.getElementById(containerId);
    if (!container) return;
    ...
    container.innerHTML = persons.map(person => `
        <div class="person-item" onclick="showPersonDetail(${person.id}, '${unitType}')">
            ...
            <div class="person-info">
                <div class="person-name">
                    ${person.name}
                    <span class="person-tag">博士后</span>
                </div>
                <div class="person-detail">${person.title} · ${person.education} · ${person.gender}</div>
            </div>
        </div>
...
function filterPersonList() {
    ...
    postdocList.style.display = 'none';
    ...
    if (currentType === 'contract') {
        ...
        let filteredContractPersons = collegeData.persons.filter(p => p.category === 'contract');
        if (keyword) {
            filteredContractPersons = filteredContractPersons.filter(p => 
                p.name.toLowerCase().includes(keyword) ||
                p.title.toLowerCase().includes(keyword) ||
                p.education.toLowerCase().includes(keyword)
            );
        }
        renderContractList(filteredContractPersons, 'college');
        return;
    }
    
    if (currentType === 'postdoc') {
        postdocList.style.display = 'block';
        
        let filteredPostdocPersons = collegeData.persons.filter(p => p.category === 'postdoc');
        if (keyword) {
            filteredPostdocPersons = filteredPostdocPersons.filter(p => 
                p.name.toLowerCase().includes(keyword) ||
                p.title.toLowerCase().includes(keyword) ||
                p.education.toLowerCase().includes(keyword)
            );
        }
        renderPostdocList(filteredPostdocPersons, 'college');
        return;
    }
    
    personList.style.display = 'block';
    
    // 全部在职：只显示在职人员（category为teacher或staff），不包括contract和postdoc
    let filtered = collegeData.persons.filter(p => p.category === 'teacher' || p.category === 'staff');
...
function filterDepartmentPersonList() {
    ...
    const contractList = document.getElementById('contract-list-dept');
    ...
    if (currentType === 'contract') {
        ...
        let filteredContractPersons = departmentData.persons.filter(p => p.category === 'contract');
        if (keyword) {
            filteredContractPersons = filteredContractPersons.filter(p => 
                p.name.toLowerCase().includes(keyword) ||
                p.title.toLowerCase().includes(keyword) ||
        ...
        renderContractList(filteredContractPersons, 'department');
        return;
    }
    
    personList.style.display = 'block';
    
    // 全部在职：只显示在职人员（category为staff），不包括contract
    let filtered = departmentData.persons.filter(p => p.category === 'staff');
...
function switchTab(tab, subType) {
    ...
    // 更新导航状态 - 根据当前单位类型选择正确的导航
    const navId = currentUnitType === 'college' ? 'nav-college' : 'nav-department';
    ...
    if (navContainer) {
        ...
        const tabOrder = currentUnitType === 'college' ? ['home', 'analysis', 'talent', 'list'] : ['home', 'analysis', 'list'];
...
function selectCollege(name, type) {
    ...
    // 切换底部导航
    document.getElementById('nav-college').style.display = type === 'college' ? 'flex' : 'none';
    document.getElementById('nav-department').style.display = type === 'department' ? 'flex' : 'none';
    ...
    if (hasData) {
        ...
        // 如果当前Tab是talent但部门没有人才Tab，切换到list
        if (currentTab === 'talent' && currentUnitType === 'department') {
            switchTab('list');
        }
...
function initTalentPage() {
    const data = currentUnitType === 'college' ? talentData.college : talentData.department;
    const listId = currentUnitType === 'college' ? 'college-talent-list' : 'dept-talent-list';
    const chartId = currentUnitType === 'college' ? 'college-talent-year-chart' : 'dept-talent-year-chart';
    
    // 渲染人才卡片列表
    renderTalentList(data, listId);
    
    // 初始化获评年份分布图表
    initTalentYearChart(data, chartId);
}

// 渲染人才卡片列表
function renderTalentList(data, containerId) {
    const container = document.getElementById(containerId);
    if (!container) return;
    
    container.innerHTML = data.map(person => `
        <div class="talent-card" onclick="showTalentDetail(${JSON.stringify(person).replace(/"/g, '&quot;')})">
            <div class="talent-card-header">
                <div class="talent-avatar">${person.name.charAt(0)}</div>
                <div class="talent-info">
                    <div class="talent-name">
                        ${person.name}
                        ${person.talents.map(t => `<span class="talent-tag">${t}</span>`).join('')}
                    </div>
                    <div class="talent-detail">${person.title} · ${person.education} · ${person.gender}</div>
                </div>
            </div>
            <div class="talent-card-body">
                <div class="talent-meta">
                    <span class="talent-meta-item">获评年份：${person.talentYear}年</span>
                    <span class="talent-meta-item">出生年份：${person.birthDate.split('-')[0]}年</span>
                </div>
            </div>
        </div>
    `).join('');
...
// 初始化获评年份分布图表
function initTalentYearChart(data, chartId) {
...
// 显示人才详情
function showTalentDetail(personData) {
    const modal = document.getElementById('detail-modal');
    const title = document.getElementById('modal-title');
    const body = document.getElementById('modal-body');
    
    title.textContent = personData.name + ' - 人才详情';
    body.innerHTML = `
        <div class="detail-card">
            <div class="detail-row">
                <span class="detail-label">姓名</span>
            ...
            <div class="detail-row">
                <span class="detail-label">人才类别</span>
                <span class="detail-value">${personData.talents.join('、')}</span>
            </div>
            <div class="detail-row">
                <span class="detail-label">获评年份</span>
                <span class="detail-value" style="color: #8C1515; font-weight: 600;">${personData.talentYear}年</span>
            </div>
        </div>
    `;
